...
diferentes jokers.
    ...
    /*Crea un Joker, con 1 como el valor asociado. (Tenga en cuenta que"nueva Carta ()"
      es equivalente a "nueva Carta (1,Carta.joker)".)*/
    public Carta() {
        indumentaria = joker;
        valor = 1;
    }
    ...
    public Carta(int elValor, int laIndumentaria) {
        if (laIndumentaria != espadas && laIndumentaria != corazones && laIndumentaria
                != diamantes && laIndumentaria != treboles && laIndumentaria != joker) {
