    ...
    static boolean playBlackjack() {
       ...
       El jugador con Blackjack gana el juego. El distribuidor gana lazos.*/
        if (manoDistribuidor.getValorBlackJack() == 21) {
            System.out.println("El distribuidor tiene la " + manoDistribuidor.getCarta(0) + " y la "
                    + manoDistribuidor.getCarta(1) + ".");
            System.out.println("El usuario tiene la " + manoUsuario.getCarta(0) + " y la"
                    + manoUsuario.getCarta(1) + " . ");
            System.out.println();
        ...
        if (manoDistribuidor.getValorBlackJack() == manoDistribuidor.getValorBlackJack()) {
            ...
            System.out.println("El distribuidor gana " + manoDistribuidor.getValorBlackJack()
                    + " Tu puntuación " + manoUsuario.getValorBlackJack() + " . ");
            return false;
        } else {
            System.out.println("Usted gana " + manoUsuario.getValorBlackJack()
                    + " Puntuacion del crupier " + manoDistribuidor + " . ");
            return true;
        }
